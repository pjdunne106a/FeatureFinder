...
public class CustomLogicBaseExpression extends Arg<WordToken> {
	   ...
	   public CustomLogicBaseExpression(String regex, RegularFunction regularFunction, TextBlock textBlock, RegexLibrary regexLibrary) {
	   ...
	   public boolean apply(WordToken wordToken) {
		   ...
		   if (!part.equalsIgnoreCase("text")) {
		       ...
		       case "predefined": {found= checkPreDefined(part, valueType, value, wordToken, textBlock, regexLibrary);}; break;
		       } 
		   } else {
	   ...
	   private String isDefinedRegex(String value) {
      ...
      private Boolean checkPreDefined(String part, String valueType, String value, WordToken wordToken, TextBlock textBlock, RegexLibrary regexLibrary) {
    	  boolean found = false;
    	  String functionName = this.getName(value);
    	  found = regularFunction.doFunction(part,functionName,value,wordToken,textBlock.getSection());
    	  return found;
